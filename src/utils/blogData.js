...
export const blogPosts = [
  {
    name: "ConCiencia Pública: una agenda de integridad para Hidalgo",
  ...
  {
    name: "Transparencia proactiva: plantillas y checklist para publicar mejor",
  ...
  {
    name: "Declaraciones de intereses: guía práctica para servidoras y servidores públicos",
  ...
  {
    name: "Contrataciones íntegras: 10 señales de alerta en compras públicas",
